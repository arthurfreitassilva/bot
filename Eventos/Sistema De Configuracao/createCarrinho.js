    ...
    run: async (interaction, client) => {
        if (interaction.type === Discord.InteractionType.ModalSubmit) {
            ...
            if (interaction.customId === '2313141') {
                ...
                if (!ggg.infos || !ggg.infos.produto || !ggg.infos.campo) {
                    return interaction.reply({
                        content: `${Emojis.get(`negative_dreamm67`)} Informações do carrinho estão incompletas.`,
                        ephemeral: true
                    });
                }
                ...
                if (!hhhh) {
                    return interaction.reply({
                        content: `${Emojis.get(`negative_dreamm67`)} Produto não encontrado.`,
                        ephemeral: true
                    });
                }
                ...
                if (!gggaaa) {
                    return interaction.reply({
                        content: `${Emojis.get(`negative_dreamm67`)} Campo não encontrado para o produto.`,
                        ephemeral: true
                    });
                }
                ...
                if (qtd > gggaaa.estoque.length) {
                    return interaction.reply({
                        content: `${Emojis.get(`negative_dreamm67`)} A quantidade solicitada de \`${qtd}\` excede o estoque disponível.`,
                        ephemeral: true
                    });
                }
                ...
                if (ggg.cupomadicionado !== undefined) {
                    ...
                    if (!hhhh2) {
                        return interaction.reply({
                            content: `${Emojis.get(`negative_dreamm67`)} Cupom não encontrado para o produto.`,
                            ephemeral: true
                        });
                    }
                    ...
                    if (!gggaaaawdwadwa) {
                        return interaction.reply({
                            content: `${Emojis.get(`negative_dreamm67`)} Cupom inválido.`,
                            ephemeral: true
                        });
                    }
                    ...
                    if (gggaaaawdwadwa.condicoes?.precominimo !== undefined) {
                        if (qtd < gggaaaawdwadwa.condicoes.precominimo) {
                            return interaction.reply({
                                content: `${Emojis.get(`negative_dreamm67`)} A quantidade solicitada de \`${qtd}\` não atinge o valor mínimo para utilizar o cupom de \`${gggaaaawdwadwa.condicoes.precominimo}\`.`,
                                ephemeral: true
                            });
                        }
        ...
        if (interaction.isButton()) {
                ...
                if (configuracao.get(`pagamentos.SemiAutomatico.status`) === true) {
                    ...
                    if (!yy || !yy.infos || !yy.infos.produto || !yy.infos.campo) {
                        return interaction.message.edit({
                            content: `${Emojis.get(`negative_dreamm67`)} Carrinho inválido ou informações incompletas.`,
                            components: [], embeds: []
                        });
                    }
            ...
            if (interaction.customId === 'confirmarpagamentomanual') {
                ...
                if (!ownerIdList.includes(interaction.user.id)) {
                    return interaction.reply({
                        content: `${Emojis.get(`negative_dreamm67`)} Você não possui permissão para usar este Botão.`,
                        ephemeral: true
                    });
                }
            ...
            if (interaction.customId.startsWith('comprarid_')) {
                ...
                if (!hhhh) {
                    return interaction.reply({
                        content: `${Emojis.get(`negative_dreamm67`)} Este produto não existe.`,
                        ephemeral: true
                ...
                if (!gggaaa) {
                    return interaction.reply({
                        content: `${Emojis.get(`negative_dreamm67`)} Este campo não existe para o produto selecionado.`,
                        ephemeral: true
                    }).then(() => interaction.message.delete());
                }
            ...
            if (interaction.customId.startsWith('foraestoquealarme_')) {
                ...
                if (gggaaa.avisar !== undefined) {
                    if (!gggaaa.avisar.includes(interaction.user.id)) {
                        ...
                        if (status === '1') {
                            interaction.reply({
                                content: `${Emojis.get(`positive_dream`)} Pronto, agora você será notificado quando \`${produtos.get(`${produto}.Config.name`)} - ${gggaaa.Nome}\` estiver com estoque disponível.`,
                                ephemeral: true
                            });
                        } else {
                            await interaction.deferUpdate();
                        ...
                        if (status === '1') {
                            interaction.reply({
                                content: `${Emojis.get(`positive_dream`)} Certo, você foi **removido** da lista de notificações de estoque de \`${produtos.get(`${produto}.Config.name`)} - ${gggaaa.Nome}\`.`,
                                ephemeral: true
                            });
                        } else {
                            await interaction.deferUpdate();
        ...
        if (Object.keys(infos).length !== 0) {
            ...
            if (gggaaa.condicao?.idcargo !== undefined) {
                ...
                if (!temCargo) {
                    return interaction.reply({
                        content: `${Emojis.get(`negative_dreamm67`)} Você não possui permissão para comprar esse produto!`,
                        ephemeral: true
                    });
                }
            }
